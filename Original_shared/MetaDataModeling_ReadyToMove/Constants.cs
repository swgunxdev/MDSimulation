...
namespace MetaDataModeling
{
		public class PayloadHeader : IToFromByteArray
		{
            ...
            {
                return (UInt32)(Mars.SizeOf<UInt16>() + Marshal.SizeOf<UInt32>() + Marshal.SizeOf<UInt16>());
            }
        ...
        public class PacketHeader : IToFromByteArray
        {
            ...
            public static UInt32 SizeOfHeader()
            {
                return (UInt32)(Marshal.SizeOf<UInt64>() * 3 + Marshal.SizeOf<UInt32>()
                                                             + Marshal.SizeOf<UInt16>());
            }
    ...
    public class Constants
	{
        ...
        //    index += (UInt32)Marshal.SizeOf(payload.Header.PayloadType);
        //    payload.Header.PayloadLength = BitConverter.ToUInt32(byteArray, (int)index);
        //    index += (UInt32)Marshal.SizeOf(payload.Header.PayloadLength);
        //    payload.Header.PayloadVersion = BitConverter.ToUInt16(byteArray, (int)index);
        //    index += (UInt32)Marshal.SizeOf(payload.Header.PayloadVersion);
        //    UInt32 payloadLength = (UInt32)(payload.Header.PayloadLength - Marshal.SizeOf(payload.Header));
        ...
        //        index += sizeof(UInt64);
        //        packet.Header.PacketLength = BitConverter.ToUInt32(byteArray, (int)index);
        //        index += sizeof(UInt32);
        ...
        //    payload.Header.PayloadLength = (UInt32)(Marshal.SizeOf(payload.Header) + payload.PayloadData.Length);
