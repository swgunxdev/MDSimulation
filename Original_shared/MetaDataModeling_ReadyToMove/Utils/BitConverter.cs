...
namespace MetaDataModeling.Utils
{
    ...
    public static class BitConverter
    {
       ...
       // [CLSCompliant(false)]
        ...
        ///     point number..cecil.mixin.getsize
        ///
        /// Parameters:
        ///   value:
        ///     The number to convert.
        ...
        public static bool ToBoolean(byte[] value, int startIndex=0)
        {
            ...
            {
                return System.BitConverter.ToBoolean(value.Reverse().ToArray(), value.Length - sizeof(Boolean) - startIndex);
            }
        }
        ///
        /// <summary>
        ...
        public static char ToChar(byte[] value, int startIndex=0)
        {
            ...
            {
                return System.BitConverter.ToChar(value.Reverse().ToArray(), value.Length - sizeof(char) - startIndex);
            }
        }
        ...
        public static double ToDouble(byte[] value) { return ToDouble(value, 0); }
        ///
        /// <summary>
